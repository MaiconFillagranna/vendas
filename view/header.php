        ...
        <ul class="nav navbar-nav">
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="cadastrobovino.html">Cadastrar Produto</a></li>
              <li role="separator" class="divider"></li>
              <li><a href="cadastroinseminacao.html">Cadastrar Venda</a></li>
            </ul>
          </li>
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="taxanatalidadeexemplar.html">Vendas</a></li>
            </ul>
          </li>
        </ul>
